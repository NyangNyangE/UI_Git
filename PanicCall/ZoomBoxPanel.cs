...
namespace ZoomBoxLibrary
{
    public class ZoomBoxPanel : System.Windows.Controls.Panel, INotifyPropertyChanged, System.ICloneable
    {
        ...
        public ZoomBoxPanel.eWheelMode WheelMode
        {
            set { SetValue(WheelModeProperty, value); }
            get { return (ZoomBoxPanel.eWheelMode)GetValue(WheelModeProperty); }
        }
        ...
        public ZoomBoxPanel.eMouseMode MouseMode
        {
            set { SetValue(MouseModeProperty, value); }
            get { return (ZoomBoxPanel.eMouseMode)GetValue(MouseModeProperty); }
        }
        ...
        static ZoomBoxPanel()
        {
            ...
            ZoomTickProperty = DependencyProperty.Register(
                "ZoomTick", typeof(double), typeof(ZoomBoxPanel),
            ...
            MinZoomTickProperty = DependencyProperty.Register(
                "MinZoomTick", typeof(double), typeof(ZoomBoxPanel),
            ...
            MaxZoomTickProperty = DependencyProperty.Register(
                "MaxZoomTick", typeof(double), typeof(ZoomBoxPanel),
                new FrameworkPropertyMetadata(100.0,
        ...
        public void ApplyZoom(bool animate)
        {
